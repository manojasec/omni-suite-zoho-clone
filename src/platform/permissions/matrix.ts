...
const managerMatrix: RoleMatrix = {
  ...
  statusPage: [...READ_WRITE_DELETE, "manage"],
  changelog: [...READ_WRITE_DELETE, "manage"],
  roadmap: [...READ_WRITE_DELETE, "manage"],
  quote: [...READ_WRITE_DELETE, "send"],
  portal: READ_WRITE_DELETE,
  goal: READ_WRITE_DELETE,
  taxRate: READ_ONLY,
  approval: [...READ_WRITE_DELETE, "manage"],
  emailTemplate: READ_WRITE_DELETE,
...
const salesMatrix: RoleMatrix = {
  ...
  statusPage: READ_ONLY,
  changelog: READ_ONLY,
  roadmap: READ_ONLY,
  dataPrepDataset: READ_ONLY,
  catalystFunction: READ_ONLY,
  assistSession: READ_ONLY,
  meeting: READ_WRITE,
  channel: READ_WRITE,
  sharedInbox: READ_ONLY,
  aiConversation: READ_WRITE,
  samlConnection: [],
  scimToken: [],
  "settings.workspace": [],
  "settings.users": [],
...
const financeMatrix: RoleMatrix = {
  ...
  portal: READ_WRITE_DELETE,
  goal: READ_ONLY,
  taxRate: READ_WRITE_DELETE,
  approval: READ_ONLY,
  emailTemplate: READ_ONLY,
  ...
  changelog: READ_ONLY,
  roadmap: READ_ONLY,
  dataPrepDataset: READ_WRITE_DELETE,
  catalystFunction: READ_ONLY,
  assistSession: READ_ONLY,
  meeting: READ_WRITE,
  channel: READ_WRITE,
...
const agentMatrix: RoleMatrix = {
  ...
  dataPrepDataset: READ_ONLY,
  catalystFunction: [],
  assistSession: READ_WRITE_DELETE,
  meeting: READ_WRITE,
  channel: READ_WRITE,
  sharedInbox: READ_WRITE_DELETE,
  aiConversation: READ_WRITE,
  samlConnection: [],
  scimToken: [],
  "settings.workspace": [],
...
const memberMatrix: RoleMatrix = {
  ...
  statusPage: READ_WRITE,
  changelog: READ_WRITE,
  roadmap: READ_WRITE,
  dataPrepDataset: READ_WRITE,
  catalystFunction: READ_ONLY,
  assistSession: READ_WRITE,
  meeting: READ_WRITE,
  channel: READ_WRITE,
  sharedInbox: READ_ONLY,
  aiConversation: READ_WRITE,
